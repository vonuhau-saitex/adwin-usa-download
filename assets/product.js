    ...
    toggleAddButton(disable = true, text = false, modifyClass = true) {
      ...
      submitButtons.forEach((submitButton) => {
        ...
        if (disable) {
          ...
          document.getElementById('backinstock-alert').classList.add('show');
          document.getElementById('backinstock-alert').classList.remove('hide');
        } else {
          submitButton.removeAttribute('disabled');
          submitButton.classList.remove('loading');
          submitButtonText.textContent = window.theme.variantStrings.addToCart;
          document.getElementById('backinstock-alert').classList.add('hide');
          document.getElementById('backinstock-alert').classList.remove('show');
        }
      });
